...
typedef enum
{
	...
	AINSCAN_FF_NOSCALEDATA 			= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	AINSCAN_FF_NOCALIBRATEDATA 		= NOCALIBRATEDATA 	// 1 << 1
}AInScanFlag;
...
typedef enum
{
	...
	AIN_FF_DEFAULT = 0,
	/** No scaling is applied to raw data. */
	AIN_FF_NOSCALEDATA 			= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	AIN_FF_NOCALIBRATEDATA 		= NOCALIBRATEDATA 	// 1 << 1
}AInFlag;
...
typedef enum
{
	...
	/** No scaling is applied to raw data. */
	AOUTSCAN_FF_NOSCALEDATA 			= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	AOUTSCAN_FF_NOCALIBRATEDATA 		= NOCALIBRATEDATA 	// 1 << 1
}AOutScanFlag;
...
typedef enum
{
	...
	AOUT_FF_DEFAULT	= 0,
	/** No scaling is applied to raw data. */
	AOUT_FF_NOSCALEDATA 			= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	AOUT_FF_NOCALIBRATEDATA 		= NOCALIBRATEDATA 	// 1 << 1
}AOutFlag;
...
typedef enum
{
	...
	CINSCAN_FF_NOCLEAR			= NOCLEAR   //1 << 3
}CInScanFlag;
...
typedef enum
{
	...
	/** No scaling is applied to raw data. */
	DAQINSCAN_FF_NOSCALEDATA 		= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	DAQINSCAN_FF_NOCALIBRATEDATA 	= NOCALIBRATEDATA, 	// 1 << 1
	/** Counters are not cleared (set to 0) when a scan starts **/
	DAQINSCAN_FF_NOCLEAR			= NOCLEAR			// 1 << 3
}DaqInScanFlag;
...
typedef enum
{
	...
	/** No scaling is applied to raw data. */
	DAQOUTSCAN_FF_NOSCALEDATA 		= NOSCALEDATA, 		// 1 << 0
	/** Turns off real-time software calibration for devices that are software calibrated. */
	DAQOUTSCAN_FF_NOCALIBRATEDATA 	= NOCALIBRATEDATA 	// 1 << 1
}DaqOutScanFlag;
...
typedef enum
{
	...
	DAQI_CTR48			= 1 << 5
	//DAQI_CTR64		// 64-bit counter won't be supported by daqInScan since the data buffer type is double
}DaqInChanType;
...
{
	/** No trigger */
	DE_NONE 						= 0, 	// read-only, intended for info
 ...
 * @param retriggerCount the number of samples per trigger to acquire with each trigger event
 * @return The UL error code.
 */
